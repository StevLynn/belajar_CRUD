...
<div class="container mt-5">
  ...
  <form action="{{ route('pasca_persalinan.store') }}" method="POST" id="pasca_persalinanForm">
    @csrf
    ...
    <!-- Step 2: Data pasca_persalinan -->
    <div class="step" id="step2" style="display:none;">
        <h2>Data pasca_persalinan</h2>
        <div>
        ...
        <div>
            <label>Apakah pasca_persalinan Terpapar Rokok?</label><br>
    ...
    <div class="step" id="step3" style="display:none;">
        ...
        <button type="submit">Simpan Data pasca_persalinan</button>
    </div>
</form>
